<template><div><h1 id="基础语法" tabindex="-1"><a class="header-anchor" href="#基础语法"><span>基础语法</span></a></h1>
<h2 id="_1-注释" tabindex="-1"><a class="header-anchor" href="#_1-注释"><span>1.注释</span></a></h2>
<ul>
<li>// 单行注释</li>
<li>/_ 多行注释 _/</li>
</ul>
<div class="language-powershell line-numbers-mode" data-highlighter="prismjs" data-ext="powershell" data-title="powershell"><pre v-pre><code><span class="line"><span class="token operator">/</span><span class="token operator">/</span> TODO: 将来完成 【可以在vscode里安装一个Todo Tree插件管理代码】</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-分割" tabindex="-1"><a class="header-anchor" href="#_2-分割"><span>2.分割</span></a></h2>
<blockquote>
<p>在 Go 语言中把行分隔符作为一条语句的结尾。也就是说,一般情况下,一行结束。</p>
</blockquote>
<h2 id="_3-命名规范" tabindex="-1"><a class="header-anchor" href="#_3-命名规范"><span>3.命名规范</span></a></h2>
<ul>
<li>标识符采用 CamelCase 驼峰命名法
<ul>
<li>如果只在包内可用,就采用小驼峰命名</li>
<li>如果要在包外可见,就采用大驼峰命名</li>
</ul>
</li>
<li>简单循环变量可以使用 i、j、k、v 等</li>
<li>条件变量、循环变量可以是单个字母或单个单词,Go 倾向于使用单个字母。Go 建议使用更短小。</li>
<li>常量使用驼峰命名</li>
<li>函数/方法的参数、返回值应是单个单词或单个字母</li>
<li>函数可以是多个单词命名,包名应该和导入路径的最后一段路径保持一致</li>
<li>接口优先采用单个单词命名,一般加 er 后缀。Go 语言推荐尽量定义小接口,接口也可以组合</li>
</ul>
<h2 id="_4-关键字" tabindex="-1"><a class="header-anchor" href="#_4-关键字"><span>4.关键字</span></a></h2>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">break        default      func         interface    select</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-预定义标识符" tabindex="-1"><a class="header-anchor" href="#_5-预定义标识符"><span>5.预定义标识符</span></a></h2>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">Types:</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-标识符" tabindex="-1"><a class="header-anchor" href="#_6-标识符"><span>6.标识符</span></a></h2>
<ul>
<li>一个名字,本质上是个字符串,用来指代一个值</li>
<li>只能是大小写字母、数字、下划线,也可以是 Unicode 字符</li>
<li>不能以数字开头</li>
<li>不能是 Go 语言的关键字</li>
<li>尽量不要使用&quot;预定义标识符&quot;,否则后果难料</li>
<li>大小写敏感</li>
</ul>
<h3 id="_6-1-标识符建议" tabindex="-1"><a class="header-anchor" href="#_6-1-标识符建议"><span>6.1 标识符建议：</span></a></h3>
<ul>
<li>不要使用中文</li>
<li>非必要不要使用拼音</li>
<li>尽量遵守上面的命名规范，或形成一套行之有效的命名规则</li>
</ul>
<h2 id="_7-字面常量" tabindex="-1"><a class="header-anchor" href="#_7-字面常量"><span>7.字面常量</span></a></h2>
<p>它是值,不是标识符,但本身就是常量,不能被修改</p>
<p>Go 语言中,boolean、rune、integer、float、complex、string 都是字面常量。其中 rune、integer、float、complex 常量被称为数值常量</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">"abc"</span>
<span class="line">'a'</span>
<span class="line">true</span>
<span class="line">1</span>
<span class="line">3.14</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 在go中整数字面量默认是int</span></span>
...
<p>无类型常量的缺省类型为 bool、rune、int、float64、complex128 或字符串</p>
</blockquote>
<h2 id="_8-常量" tabindex="-1"><a class="header-anchor" href="#_8-常量"><span>8.常量</span></a></h2>
<blockquote>
<p>常量: 使用 const 定义一个标识符,它对应的值不允许修改</p>
</blockquote>
<p>对常量并不要求全大写加下划线的命名规则</p>
<blockquote>
<p>注意: 常量必须定义时赋值,否则报错</p>
</blockquote>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">const</span> a <span class="token builtin">int</span> <span class="token operator">=</span> <span class="token number">100</span> <span class="token comment">// 指定类型定义常量并赋值</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote>
<p>注意：Go 语言的常量定义，必须是能在编译器就要完全确定其值，所以，值只能使用字面常量。</p>
</blockquote>
<h3 id="_8-1-iota" tabindex="-1"><a class="header-anchor" href="#_8-1-iota"><span>8.1 iota</span></a></h3>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 单独写iota都是从0开始</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 批量写iota从0开始, iota是行索引,在第一行不管有几个iota都是0</span></span>
<span class="line"><span class="token keyword">const</span> <span class="token punctuation">(</span></span>
...
<span class="line"><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 批量写iota从0开始,即使第一行没有写iota,iota也从第一行开始,从0开始增加</span></span>
<span class="line"><span class="token keyword">const</span> <span class="token punctuation">(</span></span>
...
<span class="line"><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">const</span> <span class="token punctuation">(</span></span>
...
<span class="line"><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-变量赋值" tabindex="-1"><a class="header-anchor" href="#_9-变量赋值"><span>9.变量赋值</span></a></h2>
<p>变量: 赋值后,可以改变值的标识符。</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">var</span> n1 <span class="token comment">// 错误, 如果不赋值,编译器无法推测类型</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 短格式 注意: 短格式不能定义在全局中</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_9-1-下划线" tabindex="-1"><a class="header-anchor" href="#_9-1-下划线"><span>9.1 下划线</span></a></h3>
<blockquote>
<p>_下划线是空白标识符</p>
</blockquote>
<ul>
<li>下划线和其他标识符使用方式一样,但它不会分配内存,不占名词空间</li>
<li>为匿名变量赋值,其值会被抛弃,因此后续代码中不能使用匿名变量的值,也不能使用匿名变量为其他变量赋值</li>
</ul>
<h3 id="_9-2-短格式" tabindex="-1"><a class="header-anchor" href="#_9-2-短格式"><span>9.2 短格式</span></a></h3>
<ul>
<li>使用:=定义变量并立即初始化</li>
<li>只能用在函数中,不能用来定义全局变量</li>
<li>不能提供数据类型,由编译器来推导</li>
</ul>
<h3 id="_9-3-零值" tabindex="-1"><a class="header-anchor" href="#_9-3-零值"><span>9.3 零值</span></a></h3>
<p>变量已经被声明,但是未被显式初始化,这是变量将会被设置为零值。</p>
<ul>
<li>int: 0</li>
<li>float: 0.0</li>
<li>bool: false</li>
...
<h3 id="_9-4-标识符本质" tabindex="-1"><a class="header-anchor" href="#_9-4-标识符本质"><span>9.4 标识符本质</span></a></h3>
<p>每一个标识符对应一个具有数据结构的值,但是这个值不方便直接访问,程序员就可以通过其对应的标识符来访问数据,标识符就是一个指代。</p>
<ul>
<li>标识符源代码时候,用来指代某个值的。编译后还有变量、常量标识符码?
<ul>
<li>答: 没有了,因为数据在内存中,内存访问靠什么? <strong>地址</strong>,标识符编译后就没有了换成了地址</li>
</ul>
</li>
<li>编译会生成二进制可执行文件并执行,在内存中开启进程,进程内有你定义的数据</li>
</ul>
<h2 id="_10-变量可见性" tabindex="-1"><a class="header-anchor" href="#_10-变量可见性"><span>10.变量可见性</span></a></h2>
<h3 id="_10-1-包级标识符" tabindex="-1"><a class="header-anchor" href="#_10-1-包级标识符"><span>10.1 包级标识符</span></a></h3>
<p>在 Go 语言中,在.go 文件中的顶层代码中,定义的标识符称为包级标识符。如果首字母大写,可在包外包内可见。如果首字母小写,则包内可见。</p>
<blockquote>
<p>同一个目录就是同一个包,同一个目录里面只能有一个包</p>
</blockquote>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 例如: 在ch1文件夹下有main.go 和 a.go, 那么它们俩文件内部只能定义同一个package 包名</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>使用建议</strong></p>
<ul>
<li>顶层代码中定义包级标识符
<ul>
<li>首字母大写作为包导出标识符,首字母小写作为包内可见标识符</li>
<li>const 定义包级常量,必须在声明时初始化</li>
<li>var 定义包级变量
<ul>
<li>可以指定类型,也可以使用无类型常量定义</li>
<li>延迟赋值必须指定类型,不然无法确定零值</li>
</ul>
</li>
</ul>
</li>
<li>有相关关系的,可以批量定义在一起</li>
<li>一般声明时,还是考虑&quot;就近原则&quot;,尽量靠近第一次使用的地方声明</li>
<li>不能使用短格式定义</li>
</ul>
<h3 id="_10-2-局部标识符" tabindex="-1"><a class="header-anchor" href="#_10-2-局部标识符"><span>10.2 局部标识符</span></a></h3>
<p>定义在函数中,包括 main 函数,这些标识符就是局部标识符</p>
<p>使用建议</p>
<ul>
<li>在函数中定义的标识符</li>
<li>const 定义局部常量</li>
...
<li>有相关关系的,可以批量定义在一起</li>
<li>在函数内,直接赋值的变量多采用短格式定义</li>
</ul>
<h2 id="_11-类型" tabindex="-1"><a class="header-anchor" href="#_11-类型"><span>11.类型</span></a></h2>
<h3 id="_11-1-布尔型" tabindex="-1"><a class="header-anchor" href="#_11-1-布尔型"><span>11.1 布尔型</span></a></h3>
<p>类型 bool,定义了 2 个预定义常量,分别是 true、false</p>
<h3 id="_11-2-数值型" tabindex="-1"><a class="header-anchor" href="#_11-2-数值型"><span>11.2 数值型</span></a></h3>
<p>复数: complex64、complex128</p>
<h4 id="_11-2-1-整数" tabindex="-1"><a class="header-anchor" href="#_11-2-1-整数"><span>11.2.1 整数</span></a></h4>
<ul>
<li>长度不同【有符号】: int8、int16(C 语言 short)、int32、int64(C 语言 long)
<ul>
<li>最高位是符号位</li>
<li>rune 类型本质上就是 int32; type rune = int32 类型 别名 type 定义时使用了 =,</li>
</ul>
</li>
<li>长度不同无符号【有符号】: uint8、uint16、uint32、uint64
<ul>
<li>u 即 unsigned,最高位不是符号位</li>
<li>byte 类型,它是 uint8 的别名</li>
</ul>
</li>
<li>自动匹配平台: int、uint
<ul>
<li>int 类型它至少占用 32 位,但一定注意它不等同于 int32,不是 int32 的别名。要看 CPU,32 位就是 4 字节,64 位就是 8 字节。但是,也不是说 int 是 8 字节 64 位,就等同于 int64,它们依然是不同类型</li>
</ul>
</li>
</ul>
<p><strong>扩展知识</strong></p>
<p>计算机内部是使用二进制的，也就是只有 0 和 1，那如何表达出正负数的区别呢？（为了让初学者便于理 解，不引入补码表示法） 为了方便以单字节为例，1 个字节是 8 位，那么可以表示 256 种状态。 如何表示十进制 2 呢？它是 00000010。那十进制-2，如何表示？ 那就把最高位单独解释，最高位定为符号位，0 表示正号，1 表示负号。-2 用二进制表示为 10000010</p>
<p><strong>进制表示</strong></p>
<ul>
<li>十六进制: 0x10、0X10</li>
<li>八进制： 0o10、0O10</li>
<li>二进制: 0b10、0B10</li>
</ul>
<blockquote>
<p>与其他语言不同,即使同是整型这个大类中,在 Go 中,也不能跨类型计算。如有必要,请强制类型转换。</p>
<p>强制类型转换: 把一个值从一个类型强制转换到另一种类型,有可能转换失败。</p>
</blockquote>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 强制类型转换又称显式类型转换</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 十进制 2</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 扩展知识</span></span>
<span class="line"><span class="token keyword">package</span> main</span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">type</span> myint <span class="token builtin">int32</span> <span class="token comment">// 特别注意这里没有等号=, 这不是别名,它是新类型,新和旧类型不是同一个类型【本质上是一样,但是定义的数据不能直接通用】</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><blockquote>
<p>可以认为 go 中没有字符类型,本质上是 int32 的别名,习惯上称 rune 为字符类型</p>
<p>在 go 中隐式类型转换,只限于 untyped constant 无类型字面量</p>
</blockquote>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 字符</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_11-2-2-浮点数" tabindex="-1"><a class="header-anchor" href="#_11-2-2-浮点数"><span>11.2.2 浮点数</span></a></h4>
<ul>
<li>float32: 最大范围约为 3.4e38, 通过 math.MaxFloat32 查看</li>
<li>float64: 最大范围约为 1.8e308, 通过 math.MaxFloat64 查看</li>
<li>打印格式化符常用%f</li>
</ul>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_11-2-3-进制及转换" tabindex="-1"><a class="header-anchor" href="#_11-2-3-进制及转换"><span>11.2.3 进制及转换</span></a></h4>
<p>常见进制有二进制、八进制、十进制、十六进制。</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 每8位(bit)位1个字节(byte)</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>二进制转八进制、十六进制</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 0b1110 计算为 1 * 2^3 + 1 * 2^2 + 1 * 2^1 + 0 * 2^0 = 14</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 这里利用 8421法来方便计算</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>八进制、十六进制转二进制</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 八进制转二进制</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>十进制转二进制、十六进制</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 十进制转二进制</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_11-2-4-转移字符" tabindex="-1"><a class="header-anchor" href="#_11-2-4-转移字符"><span>11.2.4 转移字符</span></a></h4>
<p>每一个都是一个字符,rune 类型。可以作为单独字符使用。也可以作为字符串中的一个字符</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"> \a   U<span class="token operator">+</span><span class="token number">0007</span> alert or bell</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>单引号留给表示字符,字面量表达,本质上是 int32(rune)或 byte(uint8)</p>
<h3 id="_11-3-字符串" tabindex="-1"><a class="header-anchor" href="#_11-3-字符串"><span>11.3 字符串</span></a></h3>
<p>使用双引号或反引号引起来的任意个字符,它是字面常量。</p>
<blockquote>
<p>注意: 在反引号``中使用\t 等转义字符失效</p>
</blockquote>
<blockquote>
<p>用途: 一般用于多行书写, 结构体 tag 使用</p>
</blockquote>
<p>字符串或字符中,占用的字节数(内存占用或磁盘占用),显示中在不同的显示设备中展示的显示宽度</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line">a <span class="token operator">:=</span> <span class="token string">`a	b</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_11-3-1-字符串格式化" tabindex="-1"><a class="header-anchor" href="#_11-3-1-字符串格式化"><span>11.3.1 字符串格式化</span></a></h4>
<blockquote>
<p>格式符参考 fmt 包帮助 https://pkg.go.dev/fmt</p>
</blockquote>
<ul>
<li>%v 适合所有类型数据,调用数据的缺省打印格式
<ul>
<li>%v 对于结构体,会多打印出字段名</li>
</ul>
</li>
<li>%#v 对于结构体,有更加详细的输出</li>
<li>%T 打印值的类型</li>
<li>%% 打印百分号本身</li>
</ul>
<h5 id="_11-3-1-1-整数" tabindex="-1"><a class="header-anchor" href="#_11-3-1-1-整数"><span>11.3.1.1 整数</span></a></h5>
<ul>
<li>%b 二进制; %o 八进制; %O 八进制带 0o 前缀;%x 十六进制小写;%X 十六进制大写</li>
<li>%U 把一个整数用 Unicode 格式打印。
<ul>
<li>例如: fmt.Printf(&quot;%U, %x, %c\n&quot;, 27979, 27979, 27979) =&gt; U+6D4B, 6d4b, 测</li>
</ul>
</li>
<li>%c 把 rune、byte 的整型值用字符形式打印</li>
<li>%q 把一个整型当作 Unicode 字符输出,类似%c,不过在字符外面多了单引号。q 的意思是 quote</li>
</ul>
<h5 id="_11-3-1-2-浮点数" tabindex="-1"><a class="header-anchor" href="#_11-3-1-2-浮点数"><span>11.3.1.2 浮点数</span></a></h5>
<ul>
<li>%e、%E 科学计数法</li>
<li>%f、%F 小鼠表示法, 最常用</li>
<li>%g 内部选择使用%e 还是%f 以简洁输出;%G 选择%E 或%F</li>
</ul>
<h5 id="_11-3-1-3-字符串或字节切片" tabindex="-1"><a class="header-anchor" href="#_11-3-1-3-字符串或字节切片"><span>11.3.1.3 字符串或字节切片</span></a></h5>
<ul>
<li>%s 字符串输出,如果是 rune 切片,需要 string 强制类型转换</li>
<li>%q 类似%s,外部加上双引号。q 的意思就是 quote</li>
</ul>
<h4 id="_11-3-1-4-指针" tabindex="-1"><a class="header-anchor" href="#_11-3-1-4-指针"><span>11.3.1.4 指针</span></a></h4>
<ul>
<li>%p 十六进制地址</li>
</ul>
<table>
...
<h4 id="_11-3-1-5-特殊格式符写法" tabindex="-1"><a class="header-anchor" href="#_11-3-1-5-特殊格式符写法"><span>11.3.1.5 特殊格式符写法</span></a></h4>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line">a<span class="token punctuation">,</span> b<span class="token punctuation">,</span> c<span class="token punctuation">,</span> d <span class="token operator">:=</span> <span class="token number">100</span><span class="token punctuation">,</span> <span class="token number">200</span><span class="token punctuation">,</span> <span class="token number">300</span><span class="token punctuation">,</span> <span class="token number">400</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><p>可以认为中括号内写的是索引，是 Printf 的索引，索引 0 是格式字符串本身，1 开始才是参数。如果写了 [n]，之后默认就是 n+1</p>
<h4 id="_11-3-1-6-输出函数" tabindex="-1"><a class="header-anchor" href="#_11-3-1-6-输出函数"><span>11.3.1.6 输出函数</span></a></h4>
<p>输出到标准输出</p>
<ul>
<li>Print：使用缺省格式输出,空格分隔</li>
<li>Println: 使用缺省格式输出,空格分隔,最后追加换行</li>
<li>Printf: 按照指定的格式符输出</li>
</ul>
<p>输出到字符串,经常用来拼接字符串用</p>
<ul>
<li>Sprint: 相当于 Print,不过输出为 string, 返回值为 string</li>
<li>Sprintln: 相当于 Println, 不过输出为 string</li>
<li>Sprintf: 相当于 Printf, 不过输出为 string</li>
</ul>
<h2 id="_12-操作符" tabindex="-1"><a class="header-anchor" href="#_12-操作符"><span>12.操作符</span></a></h2>
<p>参考 https://golang.google.cn/ref/spec#Operators_and_punctuation</p>
<h3 id="_12-1-逻辑运算真值表" tabindex="-1"><a class="header-anchor" href="#_12-1-逻辑运算真值表"><span>12.1 逻辑运算真值表</span></a></h3>
<p><img src="@source/go/基础语法.assets/image-20250503170807990.png" alt="image-20250503170807990"></p>
<h3 id="_12-2-算术运算符" tabindex="-1"><a class="header-anchor" href="#_12-2-算术运算符"><span>12.2 算术运算符</span></a></h3>
<p>+、-、*、/、%、++、--</p>
<ul>
<li>5/2、 -5/2</li>
<li>+、-还可以当作正负用,就不是算术运算符了,例如-s</li>
<li>类 C 语言语法没有 Python</li>
</ul>
<p>++、--只能是 i++、i--，且是语句,不是表达式。也就是说,语句不能放到等式、函数参数等地方。</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line">a <span class="token operator">:=</span> <span class="token number">10</span></span>
...
<h3 id="_12-3-常量计算问题" tabindex="-1"><a class="header-anchor" href="#_12-3-常量计算问题"><span>12.3 常量计算问题</span></a></h3>
<p>常量分类 typed 类型化常量和 untyped 常量</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">var</span> a <span class="token builtin">int</span> <span class="token operator">=</span> <span class="token number">1</span></span>
...
<span class="line">fmt<span class="token punctuation">.</span><span class="token function">Println</span><span class="token punctuation">(</span>d<span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line"> An untyped constant has a default type which is the type to which the</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_12-4-位运算符" tabindex="-1"><a class="header-anchor" href="#_12-4-位运算符"><span>12.4 位运算符</span></a></h3>
<p>&amp;位与、|位或、^异或、&amp;^位清空、&lt;&lt;、&gt;&gt;</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// &amp;位与</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>x&amp;y ，位与本质就是按照 y 有 1 的位把 x 对应位的值保留下来。</li>
<li>x&amp;^y，位清空本质就是先把 y 按位取反后的值，再和 x 位与，也就是 y 有 1 的位的值不能保留，被清空，原 来是 0 的位被保留。换句话说，就是按照 y 有 1 的位清空 x 对应位。</li>
</ul>
<h3 id="_12-5-赋值运算符" tabindex="-1"><a class="header-anchor" href="#_12-5-赋值运算符"><span>12.5 赋值运算符</span></a></h3>
<blockquote>
<p>=、+=、-=、*=、/=、%=、&gt;&gt;=、&lt;&lt;=、&amp;=、&amp;^=、^=、|=</p>
</blockquote>
<blockquote>
...
<h3 id="_12-6-逻辑运算符" tabindex="-1"><a class="header-anchor" href="#_12-6-逻辑运算符"><span>12.6 逻辑运算符</span></a></h3>
<blockquote>
<p>&amp;&amp;、||、!</p>
</blockquote>
<p>由于 Go 语言对类型的要求,逻辑运算符操作的只能是 bool 类型数据,那么结果也只能是 bool 型</p>
<h3 id="_12-7-三元运算符【注意】" tabindex="-1"><a class="header-anchor" href="#_12-7-三元运算符【注意】"><span>12.7 三元运算符【注意】</span></a></h3>
<blockquote>
<p>注意: 在 Go 中没有三元运算符</p>
</blockquote>
<h3 id="_12-8-指针" tabindex="-1"><a class="header-anchor" href="#_12-8-指针"><span>12.8 指针</span></a></h3>
<p>数据是放在内存中,内存是线性编址的。任何数据在内存中都可以通过一个地址来找到它。</p>
<blockquote>
<p>通过&amp;取地址</p>
<p>*指针变量,表示通过指针取值</p>
</blockquote>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line">a <span class="token operator">:=</span> <span class="token number">123</span></span>
...
<p>标识符的本质是指向编译后被翻译成内存地址</p>
<p>是一种类型的值,本质上是一个大整数(16 进制数), 可以理解为这个整数就是内存中门牌号码</p>
<p>*int 指向 int 类型数据的指针</p>
</blockquote>
<h3 id="_12-9-优先级" tabindex="-1"><a class="header-anchor" href="#_12-9-优先级"><span>12.9 优先级</span></a></h3>
<p><img src="@source/go/基础语法.assets/image-20250503175453721.png" alt="image-20250503175453721"></p>
<h2 id="_13-程序控制" tabindex="-1"><a class="header-anchor" href="#_13-程序控制"><span>13.程序控制</span></a></h2>
<ul>
<li>顺序
<ul>
<li>按照顺序自上向下一条条执行</li>
...
<li>分支
<ul>
<li>根据不同的情况判断,条件满足执行某条件下的语句</li>
</ul>
</li>
<li>循环
<ul>
<li>条件满足就反复执行,不满足就不执行或不再执行</li>
</ul>
</li>
</ul>
<h3 id="_13-1-if-语句" tabindex="-1"><a class="header-anchor" href="#_13-1-if-语句"><span>13.1 if 语句</span></a></h3>
<h4 id="_13-1-1-单分支" tabindex="-1"><a class="header-anchor" href="#_13-1-1-单分支"><span>13.1.1 单分支</span></a></h4>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意: Go 语言中,花括号一定要跟着 if、for、func 等行的最后,否则语法出错。【if、for、func 要与&quot;{&quot;同一行】</p>
<ul>
<li>condition 必须是一个 bool 类型,在 Go 中,不能使用其他类型等效为布尔值。</li>
<li>语句块中可以写其他代码</li>
<li>如果 condition 为 true,才能执行其后代码块</li>
</ul>
<h4 id="_13-1-2-多分支" tabindex="-1"><a class="header-anchor" href="#_13-1-2-多分支"><span>13.1.2 多分支</span></a></h4>
...
<li>前一个分支条件被测试通过,下一个条件相当于隐含着这个条件</li>
<li>一定要考虑一下 else 分支是有必要写,以防逻辑漏洞</li>
</ul>
<h4 id="_13-1-3-特殊-if" tabindex="-1"><a class="header-anchor" href="#_13-1-3-特殊-if"><span>13.1.3 特殊 if</span></a></h4>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">if</span> score<span class="token punctuation">,</span> line <span class="token operator">:=</span> <span class="token number">99</span><span class="token punctuation">,</span><span class="token number">90</span><span class="token punctuation">;</span>score <span class="token operator">></span> line <span class="token punctuation">{</span></span>
...
<p>注意: 这种写法中定义的变量作用域只能是当前 if 或 switch</p>
</blockquote>
<h3 id="_13-2-switch-语句" tabindex="-1"><a class="header-anchor" href="#_13-2-switch-语句"><span>13.2 switch 语句</span></a></h3>
<blockquote>
<p>Go 语言的 switch 有别于 C 语言的 switch,case 是独立代码块,不能穿透</p>
</blockquote>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line">a <span class="token operator">:=</span> <span class="token number">20</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码相当于下面的代码</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">switch</span> a<span class="token operator">:=</span><span class="token number">20</span><span class="token punctuation">;</span> a <span class="token punctuation">{</span></span>
<span class="line">    <span class="token keyword">case</span> <span class="token number">1</span><span class="token punctuation">:</span></span>
<span class="line">    	fmt<span class="token punctuation">.</span><span class="token function">Println</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">)</span></span>
<span class="line">    <span class="token keyword">case</span> <span class="token number">20</span><span class="token punctuation">:</span></span>
<span class="line">    	fmt<span class="token punctuation">.</span><span class="token function">Println</span><span class="token punctuation">(</span><span class="token number">20</span><span class="token punctuation">)</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Go 语言没有穿透。如果想在 Go 语言中实现穿透效果,使用 fallthrough 穿透当前 case 语句块。如非必要,不要使用 fallthrough</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">switch</span> a <span class="token operator">:=</span> <span class="token number">10</span><span class="token punctuation">;</span> a <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line">c <span class="token operator">:=</span> <span class="token number">5</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_13-3-for-循环" tabindex="-1"><a class="header-anchor" href="#_13-3-for-循环"><span>13.3 for 循环</span></a></h3>
<blockquote>
<p>注意: Go 语言没有提供 while 关键字,可以用 for 方便的替代</p>
</blockquote>
<p>C 风格 for</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">for</span> <span class="token punctuation">[</span>初始操作<span class="token punctuation">]</span><span class="token punctuation">;</span><span class="token punctuation">[</span>循环条件<span class="token punctuation">]</span><span class="token punctuation">;</span><span class="token punctuation">[</span>循环后操作<span class="token punctuation">]</span> <span class="token punctuation">{</span></span>
<span class="line">    循环体</span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>初始操作: 第一次进入循环前执行,语句只能执行一次,之后不再执行</li>
<li>循环条件: 要求返回布尔值,每次进入循环体前进行判断。如果每次条件满足返回 true,就进入循环执行一次循环体;否则循环结束</li>
<li>循环后操作: 每次循环体执行完,在执行下一次循环条件判断之前,执行该操作一次</li>
</ul>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token comment">// 死循环</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_13-3-1-continue" tabindex="-1"><a class="header-anchor" href="#_13-3-1-continue"><span>13.3.1 continue</span></a></h4>
<blockquote>
<p>终止当前这一趟循环体的执行,直接执行&quot;循环后操作&quot;后,进入下一趟循环的条件判断</p>
</blockquote>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">for</span> i<span class="token operator">:=</span><span class="token number">0</span><span class="token punctuation">;</span> i<span class="token operator">&lt;</span><span class="token number">10</span><span class="token punctuation">;</span> i<span class="token operator">++</span> <span class="token punctuation">{</span></span>
...
<p>除了 break,函数的 return 结束函数执行,当然也能把函数中的循环打断</p>
</blockquote>
<h3 id="_13-4-goto-和-label" tabindex="-1"><a class="header-anchor" href="#_13-4-goto-和-label"><span>13.4 goto 和 label</span></a></h3>
<p>goto 它会破坏结构化编程,但可以做到便利的无条件跳转</p>
<ul>
<li>跳出多重循环使用,但是问题是为什么要用多重循环?</li>
<li>到同一处标签统一处理,例如统一错误处理,问题是,写个函数也可以实现</li>
</ul>
<blockquote>
<p>goto 有时候也能简化一些代码,但是它是双刃剑,<strong>不要轻易使用</strong></p>
</blockquote>
<p>goto 需要配合标签 label 使用,label 就像代码中的锚点,goto 将无条件跳到那里开始向执行代码</p>
...
<h3 id="_13-5-for-range" tabindex="-1"><a class="header-anchor" href="#_13-5-for-range"><span>13.5 for range</span></a></h3>
<table>
<thead>
<tr>
<th>类型</th>
...
<td>s</td>
<td>&quot;abcd&quot;</td>
<td>index i int utf-8 字节偏移</td>
<td>unicode 值 rune</td>
</tr>
<tr>
<td>map</td>
<td>m</td>
...
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line">a <span class="token operator">:=</span> <span class="token string">"abc测试"</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_14-随机数" tabindex="-1"><a class="header-anchor" href="#_14-随机数"><span>14.随机数</span></a></h2>
<blockquote>
<p>标准库: math/rand</p>
</blockquote>
<p>我们使用的是伪随机数，是内部写好的公式计算出来的。这个公式运行提供一个种子，有这个种子作为 起始值开始计算。</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line">src <span class="token operator">:=</span> rand<span class="token punctuation">.</span><span class="token function">NewSource</span><span class="token punctuation">(</span><span class="token number">100</span><span class="token punctuation">)</span> <span class="token comment">// 使用种子100创建一个随机数源 rand.New(rand.NewSource(time.Now().UnixNano())) // 利用当前时间的纳秒值做种子</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><p>在 1.20 之前生成随机数</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">package</span> main</span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>全局随机数生成器 globalRand 它的种子默认为 1</p>
<p>var globalRand = New(&amp;lockedSource{src: NewSource(1). (*rngSource)})</p>
<p>如果要改变 globalRand 的种子，就需要使用 rand.Seed(2)修改种子 rand.Intn(5)就是使用它生成随机数</p>
<p>从 Go v1.20 开始，globalRand 已经改变为使用随机种子。</p>
<p>参看 Release notes https://go.dev/doc/go1.2 0</p>
<p>如果想使用旧版 globalRand 的行为，可以手动设定种子源 rand.Seed(1)或使用环境变量 os.Setenv(&quot;GODEBUG&quot;, &quot;randautoseed=0&quot;)</p>
</div></template>
